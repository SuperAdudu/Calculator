...
class Calculator:
    def __init__(self,master):
        ...
        master.geometry('357x420+0+0') # 0 + 0 = size when set full
        master.config(bg='gray')
        master.resizable(False,False) # not set full when double click or click full 
        ...
        Button(width=11,height=4, text='=',relief='flat',bg='gray',command=self.solve).place(x = 270 ,y = 350 )
        Button(width=11,height=4, text='C',relief='flat',bg='gray',command=self.clear).place(x = 0 ,y = 350 )
